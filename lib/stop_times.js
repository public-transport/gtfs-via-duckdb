...
SELECT
	...
	*
	REPLACE (
		...
		${has_pickup_type ? `,enum_range(NULL::pickup_drop_off_type)[pickup_type + 1] AS pickup_type` : ``}
		${has_drop_off_type ? `,enum_range(NULL::pickup_drop_off_type)[drop_off_type + 1] AS drop_off_type` : ``}
