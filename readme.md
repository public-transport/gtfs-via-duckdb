...
There are also [Docker images](https://github.com/public-transport/gtfs-via-duckdb/pkgs/container/gtfs-via-duckdb) available.
...
`de:11000:900100001` | `2025-05-20` >= `date` < `2025-06-03` | `2025-05-27T07:10:00+02` >= `t_departure` < `2025-05-27T07:30:00+02` | 160ms | 50
`de:11000:900100001` | `2025-05-25` >= `date` < `2025-05-28` | `2025-05-27T07:10:00+02` >= `t_departure` < `2025-05-27T07:30:00+02` | 110ms | 50
`de:11000:900100001` | `2025-05-27` >= `date` < `2025-05-28` | `2025-05-27T07:10:00+02` >= `t_departure` < `2025-05-27T07:30:00+02` | 96ms | 50
*none* | *none* | *none* | 23s (`count(*)` only) | ~263m
...
*none* | `2025-05-25` >= `date` < `2025-05-28` | `2025-05-27T07:10:00+02` >= `t_departure` < `2025-05-27T07:30:00+02` | 692ms | ~35k
*none* | `2025-05-27` >= `date` < `2025-05-28` | `2025-05-27T07:10:00+02` >= `t_departure` < `2025-05-27T07:30:00+02` | 510ms | ~35k
...
The following benchmarks were run with the [2025-05-21 VBB GTFS dataset](https://vbb-gtfs.jannisr.de/2025-05-21/) (41k `stops`, ~6m `stop_times`, ~263m arrivals/departures) using `gtfs-via-duckdb@5.0.0` and DuckDB v1.5.2 on an [M2](https://en.wikipedia.org/wiki/Apple_M2) laptop running macOS 15.7.5; All measurements are in milliseconds.

| query | avg | min | p25 | p50 | p75 | p95 | p99 | max | iterations |
| - | - | - | - | - | - | - | - | - | - |
| <pre>SELECT *<br>FROM stops<br>ORDER BY ST_Distance(stop_loc::geometry, ST_Point(9.7, 50.547)) ASC<br>LIMIT 100</pre> | 6.15 | 5.82 | 5.92 | 6.05 | 6.23 | 6.72 | 7.65 | 15.83 | 1628 |
| <pre>SELECT *<br>FROM arrivals_departures<br>WHERE route_short_name = 'S1'<br>AND t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= dates_filter_min('2025-05-27T07:10:00+02'::timestamp with time zone)<br>AND date <= dates_filter_max('2025-05-27T07:30:00+02'::timestamp with time zone)</pre> | 188.42 | 173.6 | 181.63 | 185.26 | 194.09 | 205.9 | 219.69 | 226.99 | 54 |
| <pre>SELECT *<br>FROM arrivals_departures<br>WHERE station_id = 'de:11000:900100001' -- S+U Friedrichstr. (Berlin)<br>AND t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= dates_filter_min('2025-05-27T07:10:00+02')<br>AND date <= dates_filter_max('2025-05-27T07:30:00+02')</pre> | 116.84 | 106.54 | 114.01 | 115.99 | 118.13 | 126.57 | 140.05 | 141.12 | 86 |
| <pre>SELECT *<br>FROM arrivals_departures<br>WHERE station_id = 'de:11000:900100001' -- S+U Friedrichstr. (Berlin)<br>AND t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= '2025-05-25'<br>AND date <= '2025-05-27'</pre> | 83.67 | 78.8 | 81.98 | 83.47 | 84.69 | 87.83 | 94.42 | 96.04 | 120 |
| <pre>SELECT *<br>FROM arrivals_departures<br>WHERE station_id = 'de:11000:900100001' -- S+U Friedrichstr. (Berlin)<br>AND t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= dates_filter_min('2025-05-27T07:10:00+02')<br>AND date <= dates_filter_max('2025-05-27T07:30:00+02')<br>AND stop_sequence = 0</pre> | 55.54 | 49.07 | 51.63 | 55.37 | 56.85 | 59.7 | 69.87 | 174.01 | 181 |
| <pre>SELECT *<br>FROM arrivals_departures<br>WHERE station_id = 'de:11000:900100001' -- S+U Friedrichstr. (Berlin)<br>AND t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= '2025-05-25'<br>AND date <= '2025-05-27'<br>AND stop_sequence = 0</pre> | 56.32 | 49.79 | 52.97 | 55.69 | 59.48 | 62.55 | 64.74 | 74.1 | 178 |
| <pre>SELECT *<br>FROM arrivals_departures<br>WHERE stop_id = 'de:11000:900100001::4' -- S+U Friedrichstr. (Berlin)<br>AND t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= dates_filter_min('2025-05-27T07:10:00+02')<br>AND date <= dates_filter_max('2025-05-27T07:30:00+02')</pre> | 77.8 | 68.43 | 74.06 | 77.01 | 80.55 | 87.37 | 92.15 | 93.36 | 129 |
| <pre>SELECT *<br>FROM arrivals_departures<br>WHERE stop_id = 'de:11000:900100001::4' -- S+U Friedrichstr. (Berlin)<br>AND t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= '2025-05-25'<br>AND date <= '2025-05-27'</pre> | 72.82 | 60.15 | 71.03 | 73.24 | 74.99 | 81.91 | 85.58 | 88.6 | 138 |
| <pre>SELECT *<br>FROM arrivals_departures<br>WHERE trip_id = '262623609' -- route_id=10144_109, route_short_name=S2<br>AND date = '2025-05-27'</pre> | 8.03 | 7.08 | 7.56 | 7.79 | 8.15 | 8.98 | 11.4 | 17.72 | 1246 |
| <pre>SELECT *<br>FROM arrivals_departures<br>WHERE station_id = 'de:11000:900100001' -- S+U Friedrichstr. (Berlin)</pre> | 1136.94 | 1097.91 | 1114.05 | 1128.45 | 1149.2 | 1199.16 | 1207.33 | 1209.37 | 9 |
| <pre>SELECT count(*)<br>FROM arrivals_departures<br>WHERE stop_id = 'de:11000:900100001::4' -- S+U Friedrichstr. (Berlin)</pre> | 80.19 | 71.02 | 76.04 | 79.28 | 82.01 | 89.26 | 101.49 | 113.05 | 125 |
| <pre>SELECT count(*)<br>FROM arrivals_departures<br>WHERE stop_id = 'definitely-non-existent'</pre> | 21.02 | 17.02 | 19.73 | 20.8 | 21.89 | 24.05 | 27.47 | 36.11 | 476 |
| <pre>SELECT *<br>FROM arrivals_departures<br>WHERE t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= '2025-05-25'<br>AND date <= '2025-05-27'</pre> | 1196.63 | 1100.24 | 1189.27 | 1200.27 | 1223.4 | 1246.21 | 1252.73 | 1254.36 | 9 |
| <pre>SELECT *<br>FROM arrivals_departures<br>WHERE t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND "date" >= dates_filter_min('2025-05-27T07:10:00+02'::timestamp with time zone)<br>AND "date" <= dates_filter_max('2025-05-27T07:30:00+02'::timestamp with time zone)</pre> | 32674.41 | 31265.29 | 31523 | 31780.71 | 33378.97 | 34657.59 | 34913.31 | 34977.24 | 3 |
| <pre>SELECT *<br>FROM connections<br>WHERE route_short_name = 'S1'<br>AND t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= dates_filter_min('2025-05-27T07:10:00+02')<br>AND date <= dates_filter_max('2025-05-27T07:30:00+02')</pre> | 7484.93 | 7176.2 | 7378.94 | 7581.69 | 7639.3 | 7685.39 | 7694.61 | 7696.91 | 3 |
| <pre>SELECT *<br>FROM connections<br>WHERE from_station_id = 'de:11000:900194006' -- S Schöneweide/Sterndamm (Berlin)<br>AND t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= dates_filter_min('2025-05-27T07:10:00+02')<br>AND date <= dates_filter_max('2025-05-27T07:30:00+02')</pre> | 880.24 | 834.44 | 863.27 | 866.76 | 898.58 | 933.77 | 936.36 | 937.01 | 12 |
| <pre>SELECT *<br>FROM connections<br>WHERE from_station_id = 'de:11000:900194006' -- S Schöneweide/Sterndamm (Berlin)<br>AND t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= dates_filter_min('2025-05-27T07:10:00+02')<br>AND date <= dates_filter_max('2025-05-27T07:30:00+02')<br>AND from_stop_sequence_consec = 0</pre> | 392.25 | 374.58 | 385.22 | 389.36 | 397.31 | 412.07 | 418.93 | 420.79 | 26 |
| <pre>SELECT *<br>FROM connections<br>WHERE from_stop_id = 'de:11000:900100001::4' -- S+U Friedrichstr. (Berlin)<br>AND t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= dates_filter_min('2025-05-27T07:10:00+02')<br>AND date <= dates_filter_max('2025-05-27T07:30:00+02')</pre> | 630.41 | 614.64 | 622.87 | 626.28 | 632.05 | 651.47 | 674.41 | 680.15 | 16 |
| <pre>SELECT *<br>FROM connections<br>WHERE trip_id = '262535123' -- route_id=17452_900 (M4)<br>AND date >= '2025-05-26' AND date <= '2025-06-01'</pre> | 14.28 | 12.02 | 13.21 | 13.85 | 15.07 | 17.06 | 19.58 | 30.23 | 701 |
| <pre>SELECT count(*)<br>FROM connections<br>WHERE from_stop_id = 'de:11000:900100001::4' -- S+U Friedrichstr. (Berlin)</pre> | 333.67 | 304.21 | 327.94 | 334.93 | 339.46 | 348.11 | 354.36 | 356.02 | 30 |
| <pre>SELECT count(*)<br>FROM connections<br>WHERE from_stop_id = 'definitely-non-existent'</pre> | 242.86 | 236.17 | 239.13 | 240.8 | 242.81 | 251.05 | 277.8 | 280.86 | 42 |
| <pre>SELECT *<br>FROM connections<br>WHERE t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= dates_filter_min('2025-05-27T07:10:00+02'::timestamp with time zone)<br>AND date <= dates_filter_max('2025-05-27T07:30:00+02'::timestamp with time zone)<br>ORDER BY t_departure<br>LIMIT 100</pre> | 1228811.98 | 1176217.45 | 1201481.39 | 1226745.32 | 1255109.24 | 1277800.37 | 1282338.6 | 1283473.15 | 3 |
| <pre>SELECT *<br>FROM connections<br>WHERE t_departure >= '2025-05-27T07:10:00+02' AND t_departure <= '2025-05-27T07:30:00+02'<br>AND date >= '2025-05-25' AND date <= '2025-05-27'<br>ORDER BY t_departure<br>LIMIT 100</pre> | 14740.16 | 14686.31 | 14722.68 | 14759.06 | 14767.08 | 14773.5 | 14774.78 | 14775.1 | 3 |
| <pre>SELECT *<br>FROM stats_by_route_date<br>WHERE route_id = '17452_900' -- M4<br>AND date >= '2025-05-26' AND date <= '2025-06-01'<br>AND is_effective = true</pre> | 4434.7 | 4394.44 | 4394.71 | 4394.98 | 4454.83 | 4502.72 | 4512.29 | 4514.69 | 3 |
