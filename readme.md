...
The following benchmarks were run with the [2025-05-21 VBB GTFS dataset](https://vbb-gtfs.jannisr.de/2025-05-21/) (41k `stops`, 6m `stop_times`, 207m arrivals/departures) using `gtfs-via-duckdb@5.0.0` and DuckDB v1.5.2 on an [M2](https://en.wikipedia.org/wiki/Apple_M2) laptop running macOS 15.7.5; All measurements are in milliseconds.
